...
<head>
    <script type="text/javascript">
    	...
    	$(function(){
    		$("#inventoryManager").prepend("<div class='pointer'><div class='arrow'></div><div class='arrow_border'></div></div>");
    		$("#inventoryManager").addClass("active");
    		$("#stockInquiry").addClass("active");
    		$("#stockInquiry").parent().parent().addClass("active");
    	});
