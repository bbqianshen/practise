    ...
    <script type="text/javascript">
    	...
    	$(function(){
    		...
    		if(${page.number  - 1 } < 0){
	    		...
	    		$("#pageNoSeleteor").append("<li><a target='search?path=userPermissions&pageNo=${page.number  - 1 }&userName=${condition.userName }'>&#8249;</a></li>");
    		}
    		//循环增加页码节点，并添加页码和查询条件的链接
    		while(i < ${page.totalPages } ){
   				$("#pageNoSeleteor").append("<li><a id='page" + (i + 1) + "' target='search?path=userPermissions&pageNo=" + i + "&userName=${condition.userName }'>" + (i + 1) + "</a></li>");
    			i ++;
    		}
    		...
    		$("#update").click(function(){
				...
				if(!flag){
					...
					var target = "updateUserPermission?userId=" + val;
    		...
    		$('#search').keydown(function(e){
	   			if(e.keyCode==13){
	   				...
	   				var url = "${pageContext.request.contextPath }/search?path=userPermissions&userName=" + userName;
	   				$(".pointer").remove();
    		...
    		$("#userPermissionsPage").find("a").click(function(){
...
<!-- main container -->
    <div class="content" id="userPermissionsPage">
                ...
                <div class="table-wrapper orders-table">
                    ...
                    <div class="row-fluid filter-block">
                        ...
                        <div class="pull-right">
                            <input type="text" class="search order-search" placeholder="输入内容按回车搜索" id="search"/>
                            <a class="btn-flat btn-mini info" id="view">查看权限</a>
