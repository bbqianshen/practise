    ...
    <script type="text/javascript">
    	...
    	$(function(){
    		...
    		if(${page.number  - 1 } < 0){
	    		...
	    		$("#pageNoSeleteor").append("<li><a target='search?path=fingerClient&pageNo=${page.number  - 1 }&userName=${condition.userName }'>&#8249;</a></li>");
    		}
    		//循环增加页码节点，并添加页码和查询条件的链接
    		while(i < ${page.totalPages } ){
    			$("#pageNoSeleteor").append("<li><a id='page" + (i + 1) + "' target='search?path=fingerClient&pageNo=" + i + "&userName=${condition.userName }'>" + (i + 1) + "</a></li>");
    			i ++;
    		}
    		...
    		$("#update").click(function(){
				...
				if(!flag){
					...
					$(this).attr("target","userAddPage?userId=" + val);
					//window.location.href= "userAddPage?userId=" + val; 
				}
    		});
    		...
    		$('#search').keydown(function(e){
	   			if(e.keyCode==13){
	   				...
	   				var url = "${pageContext.request.contextPath }/search?path=fingerClient&userName=" + userName;
	   				$(".pointer").remove();
    		...
    		$("#fingerClientPage").find("a").click(function(){
...
<!-- main container -->
    <div class="content" id="fingerClientPage">
            ...
            <div id="pad-wrapper">
                ...
                <div class="table-wrapper orders-table">
                    ...
                    <div class="row-fluid filter-block">
                    	<a target="userAddPage" class="btn-flat success" >
                            <span>&#43;</span>
                          	 新增用户
                        </a>
                        ...
                        <div class="pull-right">
                            ...
                            <a class="btn-flat btn-mini info" id="view">查看</a>
                            <a class="btn-flat btn-mini gray" id="update">修改</a>
                            <a class="btn-flat btn-mini danger" id="delete">删除</a>
                        </div>
