...
<head>
    <script type="text/javascript">
    	...
    	$(function(){
    		$("#personalConsole").prepend("<div class='pointer'><div class='arrow'></div><div class='arrow_border'></div></div>");
    		$("#personalConsole").addClass("active");
    		$("#backlog").addClass("active");
    		$("#backlog").parent().parent().addClass("active");
    	});
